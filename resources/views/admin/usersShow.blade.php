                    ...
                    <tr>
                            ...
                            <div class="flex items-center">
                                <div class="mx-auto">
                                    <a href="#" class="  text-black flex    transition-colors duration-200 justify-center  hover:font-bold">
                                        <span class="text-gray-900 whitespace-nowrap">  {{ $user->name }}</span>
                                    </a>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-5 py-5 border-gray-200 bg-white text-lg  ">
                            <div class="flex items-center">
                                <div class="mx-auto ">
                                    <a href="#" class="  text-black flex    transition-colors duration-200 justify-center  hover:font-bold">
                                        <span class="text-gray-900 whitespace-nowrap">{{$user->tickets_count}}</span>
                                    </a>
                                </div>
                            </div>
                        </td>
                        <td class="px-5 py-5 border-gray-200 bg-white text-lg  ">
                            <div class="flex items-center">
                                <div class="mx-auto ">
                                    <a href="{{route('users.destroy',$user)}}" class="  text-black flex    transition-colors duration-200 justify-center  hover:font-bold">
                                        <span class="text-gray-900 whitespace-nowrap">{{$user->open_tickets_count}}</span>
                                    </a>
                                </div>
                            </div>
                        </td>
