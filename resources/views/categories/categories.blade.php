                        ...
                        <td class="px-5 py-5 border-gray-200 bg-white text-lg  ">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="  text-black flex    transition-colors duration-200 justify-center  hover:font-bold">
                                        <span class="text-gray-900 whitespace-nowrap">3</span>
                                    </a>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-5 py-5 border-gray-200 bg-white text-lg  ">
                            <div class="flex  justify-center items-center   ">
                                <div class="ml-3 bg-red-500 rounded-lg w-8 h-6">
                                    <a href="#" class=" font-normal text-white flex    transition-colors duration-200 justify-center  hover:text-gray-500">
