...
<body class="bg-gray-100 h-screen overflow-hidden relatives ">
    <div class="flex item-start justify-start ">
        ...
        <div class="pl-10 bg-gray-100 w-screen  ">
            <h1 class="my-10 text-5xl font-bold">Dashboard</h1>
            <div class=" bg-white rounded-lg ">
                <a href="#" class="w-full font-bold  flex items-center  p-6 my-4 transition-colors duration-200 justify-start  hover:text-gray-500 text-orange-500">
                    <span class="text-center bg-orange-200 w-16 h-16 rounded-full ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 m-3">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 010 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 010-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375z" />
                        </svg>
                    </span>
                    <div>
                        <p class=" font-bold text-2xl m-4 text-gray-500"> Total tickets</p>
                        <p class=" font-bold text-2xl m-4  text-black">3</p>
                    </div>
                </a>
            </div>
        </div>
